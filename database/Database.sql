...
CREATE TABLE `approval_rule_stages` (
  ...
  `role` enum('cost_center_manager','project_manager','manager','admin') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2026-01-29 13:16:36
