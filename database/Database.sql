...
INSERT INTO `approval_workflows` VALUES (63,116,NULL,1,2,1,'Pending',18,NULL,NULL,'2026-01-22 13:33:29'),(64,117,8,1,5,1,'Pending',18,NULL,NULL,'2026-01-22 13:33:54'),(65,117,8,2,1,2,'Waiting',22,NULL,NULL,'2026-01-22 13:33:54');
...
CREATE TABLE `escalation_rules` (
  ...
  KEY `ix_escalation_rules_role` (`notify_role_id`),
  CONSTRAINT `escalation_rules_ibfk_1` FOREIGN KEY (`notify_user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_escalation_rules_roles` FOREIGN KEY (`notify_role_id`) REFERENCES `roles` (`id`) ON DELETE SET NULL
...
INSERT INTO `notifications` VALUES (214,2,116,'invoice_approval_required','Neue Rechnung zur Freigabe','Rechnung FAT-001-2026 von Azienda Demo SRL über 300,00 € EUR wartet auf Ihre Freigabe.',0,'normal','/invoices/116','2026-01-22 13:33:29',NULL),(215,3,116,'invoice_received','Neue Rechnung eingegangen','Rechnung FAT-001-2026 von Azienda Demo SRL über 300,00 € EUR ist eingegangen.',0,'low','/invoices/116','2026-01-22 13:33:29',NULL),(216,1,116,'invoice_received','Neue Rechnung eingegangen','Rechnung FAT-001-2026 von Azienda Demo SRL über 300,00 € EUR ist eingegangen.',1,'normal','/invoices/116','2026-01-22 13:33:29','2026-01-27 08:14:22'),(217,5,117,'invoice_approval_required','Neue Rechnung zur Freigabe','Rechnung FAT-002-2026 von Azienda Demo SRL über 1.250,00 € EUR wartet auf Ihre Freigabe.',0,'normal','/invoices/117','2026-01-22 13:33:55',NULL),(218,3,117,'invoice_received','Neue Rechnung eingegangen','Rechnung FAT-002-2026 von Azienda Demo SRL über 1.250,00 € EUR ist eingegangen.',0,'low','/invoices/117','2026-01-22 13:33:55',NULL),(219,1,117,'invoice_received','Neue Rechnung eingegangen','Rechnung FAT-002-2026 von Azienda Demo SRL über 1.250,00 € EUR ist eingegangen.',1,'normal','/invoices/117','2026-01-22 13:33:55','2026-01-27 08:14:22'),(220,2,117,'invoice_received','Neue Rechnung eingegangen','Rechnung FAT-002-2026 von Azienda Demo SRL über 1.250,00 € EUR ist eingegangen.',0,'normal','/invoices/117','2026-01-22 13:33:55',NULL);
...
-- Dump completed on 2026-01-27 15:36:31
